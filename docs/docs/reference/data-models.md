...
All models inherit from a shared `Base` class and one of two timestamp mixins defined in `apps/backend/src/app/models/base.py`.
...
**Table:** `datasets` &nbsp;|&nbsp; **Mixin:** `TimestampMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `connections` &nbsp;|&nbsp; **Mixin:** `TimestampMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `schema_metadata` &nbsp;|&nbsp; **Mixin:** `CreatedAtMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `conversations` &nbsp;|&nbsp; **Mixin:** `TimestampMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `messages` &nbsp;|&nbsp; **Mixin:** `CreatedAtMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `saved_queries` &nbsp;|&nbsp; **Mixin:** `TimestampMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
**Table:** `provider_configs` &nbsp;|&nbsp; **Mixin:** `TimestampMixin` &nbsp;|&nbsp; **Source:** `apps/backend/src/app/models/orm.py`
...
```python title="apps/backend/src/app/models/base.py"
...
DataX uses **Alembic** for schema migrations. The migration configuration lives in `apps/backend/alembic/`.
