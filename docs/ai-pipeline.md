...
``` python title="backend/app/services/schema_context.py"
@dataclass
...
``` python title="backend/app/services/agent_service.py"
...
``` python title="backend/app/services/nl_query_service.py"
