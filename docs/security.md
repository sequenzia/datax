...
```python title="backend/app/encryption.py"
def _load_key() -> bytes:
...
```python title="backend/app/services/query_service.py"
...
```python title="backend/app/api/v1/connections.py"
...
```python title="backend/app/api/v1/providers.py"
...
```python title="backend/app/services/cross_source_query.py"
...
```python title="backend/app/services/file_upload.py"
